...
USER_PROMPT_AGENT_PATH = "prompts/agent.txt"
USER_PROMPT_AGENT_CUSTOMER_PATH = "prompts/agent_customer.txt"
USER_PROMPT_COMMON_HEADERS_PATH = "prompts/common_headers.txt"
USER_PROMPT_AGENT_METRICS_AUDIO_PATH = "prompts/agent_metrics_audio.txt"
USER_PROMPT_CALL_METRICS_TRANSCRIPT_PATH = "prompts/call_metrics_transcript.txt"
AGENT_SCRIPT_DISH_PATH = "prompts/dish_script.csv"
AGENT_SCRIPT_D2H_PATH = "prompts/d2h_script.csv"

# Load scripts
dish_script = pd.read_csv(AGENT_SCRIPT_DISH_PATH)
d2h_script = pd.read_csv(AGENT_SCRIPT_D2H_PATH)

NOUN_CORPUS_PATH = "prompts/transcript_corpus.xlsx"
